...
import { LiveUrlAdminController } from '~/modules/admin/presentation/http/live-url-admin.controller';
...
@Module({
  imports: [ScoreModule, UserModule, BetQuestionModule, PlayerModule, MatchRecordModule, LikeModule, LiveUrlModule],
  controllers: [
