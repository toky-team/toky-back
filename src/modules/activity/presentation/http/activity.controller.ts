...
import { GetActivityRanksRequestDto } from '~/modules/activity/presentation/http/dto/get-ranks.request.dto';
...
export class ActivityController {
  ...
  @Public()
  async getRanks(@Query() query: GetActivityRanksRequestDto): Promise<PaginatedResult<ActivityRankResponseDto>> {
